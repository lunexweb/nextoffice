    ...
    if (invoiceUserId) {
      try {
        ...
        if (ownerEmail && ownerEmail !== recipientEmail) {
          ...
          const ownerSubject = `💰 Payment received from ${recipientName} — ${invoiceNumber}`;
...
<body style="margin:0;padding:0;background-color:#f1f5f9;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f1f5f9;padding:40px 16px;"><tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
      <tr><td style="background-color:#064e3b;padding:24px 40px;">
        <p style="margin:0 0 2px;color:rgba(255,255,255,0.5);font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:2px;">Payment Update</p>
        <h1 style="margin:0;color:#ffffff;font-size:18px;font-weight:700;">💰 Payment Confirmation Sent</h1>
      </td></tr>
      <tr><td style="background-color:#10b981;height:3px;font-size:0;line-height:0;">&nbsp;</td></tr>
      <tr><td style="padding:28px 40px 20px;">
        <p style="margin:0 0 16px;color:#475569;font-size:14px;line-height:1.7;">
          A <strong>payment confirmation</strong> email was sent to <strong style="color:#0f172a;">${recipientName}</strong> for invoice <strong>${invoiceNumber}</strong> (${formattedAmount}). The invoice is now marked as paid.
        </p>
        <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8fafc;border-radius:10px;overflow:hidden;margin-bottom:24px;border:1px solid #e2e8f0;">
          <tr><td colspan="2" style="background-color:#10b98114;padding:12px 16px;border-bottom:1px solid #e2e8f0;">
            <p style="margin:0;color:#10b981;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;">Payment Summary</p>
          </td></tr>
          <tr><td style="padding:10px 16px;color:#64748b;font-size:13px;border-bottom:1px solid #f1f5f9;">Client</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:600;color:#1e293b;border-bottom:1px solid #f1f5f9;">${recipientName}</td></tr>
          <tr><td style="padding:10px 16px;color:#64748b;font-size:13px;border-bottom:1px solid #f1f5f9;">Invoice</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:600;color:#1e293b;border-bottom:1px solid #f1f5f9;">${invoiceNumber}</td></tr>
          <tr><td style="padding:10px 16px;color:#64748b;font-size:13px;border-bottom:1px solid #f1f5f9;">Amount</td><td style="padding:10px 16px;text-align:right;font-size:15px;font-weight:700;color:#10b981;border-bottom:1px solid #f1f5f9;">${formattedAmount}</td></tr>
          <tr><td style="padding:10px 16px;color:#64748b;font-size:13px;">Payment Date</td><td style="padding:10px 16px;text-align:right;font-size:13px;font-weight:600;color:#1e293b;">${formattedDate}</td></tr>
        </table>
        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:20px;"><tr><td align="center">
          <a href="${dashboardUrl}" style="display:inline-block;background-color:#10b981;color:#ffffff;font-size:14px;font-weight:700;text-decoration:none;padding:14px 40px;border-radius:8px;">View in Dashboard →</a>
        </td></tr></table>
